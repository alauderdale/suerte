...
if ($_COOKIE['iwashere'] != "yes") { 
  ...
  header("Location: http://drinksuerte.com/?pagename=enter"); 
}
?>
...
<!--         register custom post type for tequila-->
 ...
 <section id="storelocate" class="clearfix section">
     ...
     <div id="no-store" class="orange-bar">
         ...
         <h4>Click 
             <a href="index.php?pagename=contact" data-fancybox-type="ajax" class="fancybox">HERE</a>
     ...
     <div class="wrapped">
         ...
         <div class="media-container" id="media-contain" class="clearfix">
             ...
             <?php while ( $pressloop->have_posts() ) : $pressloop->the_post(); ?>
                 <div class="press-item box">
                     <div class="press-item-contain">
